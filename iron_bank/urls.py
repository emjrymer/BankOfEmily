...
from app.views import SignUpView, AccountNumberList, AccountCreateView, AccountDetailView, TransactionCreateView, TransactionListView, TransferCreateView, TransactionDetailView, OverDraftView, \
...
urlpatterns = [
    ...
    url(r'^transactionlist/(?P<pk>\d+)/$', TransactionListView.as_view(), name="trans_list_view"),
    ...
    url(r'^createtransaction/(?P<pk>\d+)/$', TransactionCreateView.as_view(), name="trans_create_view"),
    url(r'^transactiondetail/(?P<pk>\d+)/$', TransactionDetailView.as_view(), name="trans_detail_view"),
